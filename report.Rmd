...
input_user <- list(date_range, params$dur_input, prob_input, params$street_input,
...
## Type of Bike Parking Demand by Time of Day (24h)
...
# Rename duration values for heat map axis
heat_data_2$duration <- if_else(heat_data_2$duration == "minutes", "Minutes",
                          if_else(heat_data_2$duration == "hours", "Hours",
                            if_else(heat_data_2$duration == "days", "Days", "Overnight")))
